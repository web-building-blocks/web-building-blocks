...
3. **Visual Feedback**: The background and text colour of each tag swap temporarily when interacted with. This immediate visual feedback is crucial for user assurance.
...
5. **Text and Background Contrast**: The text and background colours are selected to maintain good contrast, making it easier for people with vision impairments to read the content.
